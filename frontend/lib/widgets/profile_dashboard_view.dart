    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          else if (profile.metrics.isEstimated)
            Container(
              margin: const EdgeInsets.only(bottom: 20),
              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
              decoration: BoxDecoration(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildStatCard('Followers', followers, isDark),
                    _buildStatCard('Following', following, isDark),
                    _buildStatCard('Posts', posts, isDark),
                  ],
                ),
              ],
            ),
